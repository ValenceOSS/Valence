 ...
 *   whatever the page is showing and should let it through. `clear` is the same glass in the
 *   theme's own tint, for a bar floating over the page in either theme.
