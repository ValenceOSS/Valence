...
/**
 * Opens the visualiser page, or closes it.
 *
 * @param open - Whether it should be open.
 */
const setMusicVisualiser = (open: boolean): void => {
  isOpen = open;
...
/**
 * Reads whether the visualiser page is open, so the cover on the player bar can
 * open it and the view itself can be drawn wherever the shell keeps it.
 *
 * @returns Whether it is open.
 */
const useMusicVisualiser = (): boolean =>
...
export { setMusicVisualiser, useMusicVisualiser };
