...
const QUALITIES: readonly [RegExp, MusicQuality][] = [
  [/\balac\b/i, 'alac'],
  [
    /\bflac(?![a-z]).*\b24 ?(bit|b)\b|\b24 ?(bit|b)\b.*\bflac(?![a-z])|\b24[ -](44|48|88|96|176|192)\b|\bhi-?res\b/i,
    'flac24',
  ],
  [/\bflac(?![a-z])/i, 'flac'],
  [/\b320 ?(kbps|k)?\b/i, 'mp3-320'],
  [/\bv0\b/i, 'mp3-v0'],
  [/\b256 ?(kbps|k)\b|\bm4a\b|\baac(?![a-z])/i, 'aac'],
  [/\bopus\b/i, 'opus'],
  [/\bv2\b/i, 'mp3-v2'],
  [/\bmp3\b/i, 'mp3'],
];
 ...
 * V0 or V2, AAC, or Opus — the first that fits, best first. A format may run into its channels, as
 * `FLAC2.0` does.
 *
