...
import { thePhonesMusicAudio } from '@ValenceMobile/music/thePhonesMusicAudio';
import type { MusicAudio } from '@ValenceClient/platform/Platform.types';
import type { NativeMusic } from './NativeMusic.types';

/**
 * What the client's music player plays through on a phone: the phone's own speaker. An iPhone cannot
 * play Ogg, so there a track kept as Opus or Vorbis is played from the server's high-quality
 * encode; Android plays it as it is.
 *
